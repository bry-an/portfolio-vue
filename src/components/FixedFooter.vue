...
<script>
  export default {
    ...
    methods: {
        ...
        // document.getElementById('contact-window').style.display = 'inherit';
        ...
        document.getElementById('contact-window').classList.add('contact-window-hidden');
        document.getElementById('contact-window').classList.remove('contact-window');
        document.getElementById('footer-contact-button').style.display = 'inherit';
        if (contactWindowBody.contains(document.getElementById('thanks-message'))) {
       contactWindowBody.removeChild(document.getElementById("thanks-message"));
       contactWindowBody.removeChild(document.getElementById("thanks-message-button"));
}
        },
